...
(function( $ ) {
  $.fn.retina = function( options ) {
    ...
    // Browser check from http://detectmobilebrowsers.com/
    ...
    if(settings.overridePixelRatio || window.devicePixelRatio >= 1.2) {
      if (!settings.enabledForMobile && mobileCheck()) {
        retinaEnabled = false;
      } else {
        retinaEnabled = true;
      } 
